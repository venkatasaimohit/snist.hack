...
getDocs(colRef)
    .then((snapshot) => {
        ...
        document.getElementById('prescriptionContainer').innerHTML = createPrescriptionTable(prescriptions);
    })
    .catch((err) => {
        console.log(err.message);
        document.getElementById('prescriptionContainer').innerHTML = `<div class="error">Error loading prescriptions: ${err.message}</div>`;
    });
